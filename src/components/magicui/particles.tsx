...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  // Setup: canvas init + IntersectionObserver to pause when off-screen
  useEffect(() => {
    ...
    // Mouse handler — only track when visible
    ...
    // IntersectionObserver: only animate when the canvas is in the viewport
