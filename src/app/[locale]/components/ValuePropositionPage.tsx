...
function ValueCard({
  ...
  item: { title: string; text: string; iconIndex: number };
  index: number;
}) {
  ...
  const icons = [
    // Dollar sign
    <svg key="dollar" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <line x1="12" y1="2" x2="12" y2="22" />
      <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
    </svg>,
    // Activity
    <svg key="activity" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
    </svg>,
    // Settings
    <svg key="settings" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export default function ValuePropositionPage() {
  ...
  return (
    <section id="propuesta" className="mt-[100px] mb-[150px] px-[70px] max-sm:px-[32px]">
      <div className="flex flex-col gap-[60px] max-sm:gap-[50px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {items.map((item, i) => (
            <ValueCard key={i} item={{ ...item, iconIndex: i }} index={i} />
          ))}
        </div>
      </div>
    </section>
